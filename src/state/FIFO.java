...
//		
		...
		String str = "Queue: ";// Skapar bas-stringen, men värdet "Queue: "

		for (Object elem : queue) { // For-each loop
			str = str.concat("(").concat(String.valueOf(elem)).concat(") "); // I str läggs det till så att stringen =
