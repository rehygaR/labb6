...
public class SupermarketState extends SimState {
	...
	private int freeCheckouts; // Detta ska räknas ut genom att ta i akt på FIFO tillståndet och antal personer
								// i snabbköpet
	private double sumTimeFreeCheckouts; // Summering av tiden som det funnits lediga kassor. Slutas räknas då sista
											// kunden betalat och lämnat snabbköpet. (Även om det kommer en ny kund som
											// inte kommer in pga stängning)
	private int numCustomersLeaving; // Antal kunder som handlat och lämnar snabbköpet (genomgått alla
										// kund-händelser)
	...
	private ArrivalTime arrive;// = new ArrivalTime(4.0); // Ankomsttidskälla, 4.0 bytsut mot det man anger i
								// runSim
	private PickupTime pickup;// = new PickupTime(0.5,1.0); // Plocktidskälla, parametrar byts ut mot de
								// angivna i runSim ( variabler)
	 ...
	 */
	public String getStringQueue() { // Returnerar en sträng av kön, id på kund och vilken plats (index 0 = längst
										// fram, FIFO)
